...
TEST(TestField, getPlayersOnFieldManyPlayers)
{
    ...
    auto player0 = std::make_unique<ConsolePlayer>("", 1, board);
    auto player1 = std::make_unique<ConsolePlayer>("", 1, board);
    auto player2 = std::make_unique<ConsolePlayer>("", 1, board);
    auto player3 = std::make_unique<ConsolePlayer>("", 1, board);
